...
<div class="container">
    <div id="pf-hd">
        <div class="pf-logo">
            <img src="${ctx}/resources/images/main/main_logo.png" alt="logo">
        </div>
        ...
        <div class="pf-user">
            <div class="pf-user-photo">
                <img style="width: 40px;height: 40px;" src="${ctx}/resources/images/main/user.png" alt="">
            </div>
            <h4 class="pf-user-name ellipsis">${user_session.name}</h4>
            ...
            <div class="pf-user-panel">
                <ul class="pf-user-opt">
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont">&#xe60d;</i>
                            <span class="pf-opt-name">信息</span>
                        </a>
                    </li>
                    <li id="exit">
                        <a href="${ctx}/loginOut">
    ...
    <div id="pf-bd">
        <div id="pf-sider">
            ...
            <ul class="sider-nav" id="sider-nav">
                ...
                <%--                                <li>--%>
                <%--                                    <a href="javascript:addPanel('${secondModule.code }' ,'${secondModule.url }','${secondModule.name}');">${secondModule.name}</a>--%>
                <%--                                </li>--%>
                <%--                            </c:forEach>--%>
                <%--                        </ul>--%>
                <%--                    </li>--%>
                <%--                </c:forEach>--%>
                    ...
                    <li>
                        <a href="javascript:;">
                            <span class="iconfont sider-nav-icon">&#xe611;</span>
                            <span class="sider-nav-title">系統管理</span>
                            <i class="iconfont">&#xe642;</i>
                        </a>
                        <ul class="sider-nav-s">

                            <li>
                                <a href="javascript:addPanel('00010001' ,'/identity/user/selectUser','用户管理');">用戶管理</a>
                            </li>
                            <li>
                                <a href="javascript:addPanel('00010002' ,'/identity/role/selectRole','角色管理');">角色管理</a>
                            </li>
                            <li>
                                <a href="javascript:addPanel('00010003' ,'/identity/module/mgrModule','操作管理');">操作管理</a>
                            </li>
                        </ul>
                    </li>
            </ul>
        ...
        <div id="pf-page">
            <div class="easyui-tabs" id="tt" style="width:100%;height:100%;">
                <div title="当前用户" id="user" style="padding:10px 5px 5px 10px;">
                    <iframe class="page-iframe" src="${ctx}/comn/home" frameborder="no" border="no" height="100%"
