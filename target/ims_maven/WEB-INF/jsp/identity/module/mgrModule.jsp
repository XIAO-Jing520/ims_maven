        ...
        $(function () {
            ...
            $.ajax({
                ...
                success: function (arr) {
                    $.each(arr,function(){
                        d.add(this.code,this.vcode,this.name,this.url,this.name,"rightFrame");
...
<div data-options="region:'center'" title="模块菜单">
    <!-- 展示当前模块下的子模块  -->
    <iframe src="${ctx}/identity/module/module" frameborder="0" id="sonModules" name="rightFrame" width="100%"
            height="100%"></iframe>
</div>
</body>
</html>
