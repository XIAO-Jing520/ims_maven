...
$(function(){
   ...
   $("#back").click(function(){
	   parent.window.location = "${ctx}/identity/role/selectRole.jspx";
   });
   /** 固定表的高度 */
   ...
   $("#bindPopedom").click(function(){
	   ...
	   window.location = "${ctx}/identity/popedom/bindPopedom.jspx?codes="+params.get()+"&parentCode=${parentCode}&id=${role.id}&name=${role.name}&moduleName=${moduleName}";
   })
});
