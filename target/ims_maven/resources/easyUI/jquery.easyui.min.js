    ...
    function _3be(_3bf, _3c0, _3c1) {
        ...
        function _3c7() {
            ...
            if (_3c0 == "east") {
                ...
                return {
                    resizeC: {width: _3ce},
                    expand: {left: cc.width() - _3cd},
                    expandP: {top: _3cb.top, left: cc.width() - _3cc, width: _3cc, height: _3cb.height},
                    collapse: {left: cc.width(), top: _3cb.top, height: _3cb.height}
                };
            } else {
                if (_3c0 == "west") {
                    var _3cd = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3ce, left: _3cc - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3cb.top, width: _3cc, height: _3cb.height},
                        collapse: {left: -_3cd, top: _3cb.top, height: _3cb.height}
                    };
                } else {
                    if (_3c0 == "north") {
                        ...
                        return {
                            resizeC: {top: _3cc - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3cc},
                            collapse: {top: -_3cf, width: cc.width()}
                        };
                    } else {
                        if (_3c0 == "south") {
                            var _3cf = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3cf},
                                expandP: {top: cc.height() - _3cc, left: 0, width: cc.width(), height: _3cc},
    ...
    function _3d0(_3d1, _3d2) {
        ...
        function _3d7() {
            ...
            if (_3d2 == "east" && _3d3.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _3d8.top, height: _3d8.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3d2 == "west" && _3d3.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _3d8.top, height: _3d8.height},
                        expand: {left: 0}
                    };
                } else {
...
(function ($) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        showFooter: false,
        scrollbarSize: 18,
        rowEvents: {mouseover: _64b(true), mouseout: _64b(false), click: _653, dblclick: _65d, contextmenu: _661},
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _9a7, keydown: _9ab, paste: _9ab, drop: _9ab},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
