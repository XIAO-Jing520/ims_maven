    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (totalNum > 0) {
                ...
                sbf.append("<tr><td>总共<font color='red'>" + this.totalNum + "</font>条记录,当前显示" + startSize + "-" + endSize + "条记录</td></tr></table>");

            } else {

                sbf.append("<table align='center' style='width:100%;font-size:14px;'><tr><td align='center'>总共0条记录,当前显示0-0条记录</td></tr></table>");
